...
# Additionally, forwards_compat consists of very specific hardcoded offers that don't take into account all parameters.
...
async def test_cat_trades(
    ...
    if test_aggregation:
        ...
        result: NPCResult = get_name_puzzle_conditions(
            program, INFINITE_COST, mempool_mode=True, height=active_softfork_height
        )
